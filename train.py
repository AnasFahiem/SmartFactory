...
def train_model():
    ...
    # ─── TRAIN ────────────────────────────────────────────────────────────────
    # Settings optimized for RTX 2050 (4GB VRAM):
    #   - imgsz=640  : Safe for 4GB VRAM with batch=8
    #   - batch=8    : Fits in 4GB; increase to 16 if no OOM errors appear
    ...
    results = model.train(
        ...
        batch=16,           # Safe for 8GB VRAM at imgsz=1280 with yolo11l
        device=device,
